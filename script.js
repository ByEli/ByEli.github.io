...
document.getElementById('enviarCorreo').addEventListener('click', function() {
    ...
    const asunto = `Nuevo mensaje desde el formulario: ${tema}`;
    const cuerpo = `Nombre: ${nombre}\nTeléfono: ${telefono}\nCorreo: ${correo}\nMensaje: ${mensaje}`;

    // Abre el cliente de correo con los datos prellenados
    window.location.href = `mailto:eliannaiujo@gmail.com?subject=${encodeURIComponent(asunto)}&body=${encodeURIComponent(cuerpo)}`;
});
